...
if ( ! defined( 'WP_UNINSTALL_PLUGIN' ) ) {
	exit;
		...
		// Leave no trail wp-thumbtack-review-slider_version widget_wpthumbtack_widget
		$option1 = 'wp-thumbtack-review-slider_version';
		$option2 = 'wpthumbtack_thumbtack_settings';
		$option3 = 'widget_wpthumbtack_widget';
		$option4 = 'wpthumbtack_options';
