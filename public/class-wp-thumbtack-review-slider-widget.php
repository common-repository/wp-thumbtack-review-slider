...
class wpthumbtack_Widget extends WP_Widget {

  // Set up the widget name and description.
  public function __construct() {
    $widget_options = array( 'classname' => 'wpthumbtack_widget', 'description' => 'Widget for WP Thumbtack Review Slider Plugin. Allows you to display your reviews in your widget areas.' );
    parent::__construct( 'wpthumbtack_widget', 'WP Thumbtack Review Slider', $widget_options );
  }
  ...
  public function widget( $args, $instance ) {
	...
	if($templatedetails){
		...
		include plugin_dir_path( __FILE__ ) . 'partials/wp-thumbtack-review-slider-public-display-widget.php';
...
// Register the widget.
function wpthumbtack_register_widget() { 
  register_widget( 'wpthumbtack_Widget' );
}
add_action( 'widgets_init', 'wpthumbtack_register_widget' );
