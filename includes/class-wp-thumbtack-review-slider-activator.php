 ...
 */
class WP_Thumbtack_Review_Activator {
	...
	public static function activate() {
		...
		//setup cron to get thumbtack once a day
		if (! wp_next_scheduled ( 'wpthumbtack_daily_event' )) {
			wp_schedule_event(time(), 'daily', 'wpthumbtack_daily_event');
		}
	}
